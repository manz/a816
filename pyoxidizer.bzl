...
def make_exe(dist):
    ...
    # python_config.run_command = "from a816.cli import cli_main; cli_main()"

    # Run a Python module as __main__ when the interpreter starts.
    python_config.run_module = "a816.cli.x816"
...
def make_install(exe):
    ...
    files.add_python_resource("x816", exe)
